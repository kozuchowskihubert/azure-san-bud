            ...
            {steps.map((step, index) => (
              ...
              >
                ...
                {index < steps.length - 1 && (
                  <div className="lg:hidden absolute left-8 top-20 bottom-0 w-0.5 bg-gradient-to-b from-primary to-accent opacity-30"></div>
                )}

                {/* Step Card */}
                <div className={`relative bg-white rounded-2xl p-6 shadow-lg hover:shadow-2xl transition-all duration-300 border-2 border-gray-100 hover:border-primary/20 group ${
                  index % 2 === 0 ? 'lg:mt-0' : 'lg:mt-12'
                }`}>
                  {/* Step Number Badge */}
                  <div className="absolute -top-4 -left-4 w-16 h-16 bg-gradient-to-br from-primary to-accent rounded-xl flex items-center justify-center shadow-lg group-hover:scale-110 group-hover:rotate-6 transition-all duration-300">
