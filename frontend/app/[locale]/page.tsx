      ...
      <section className="relative h-[600px] md:h-[700px] overflow-hidden">
        ...
        <div className="relative z-10 container mx-auto px-4 h-full flex items-center">
          <div className="max-w-4xl mx-auto text-center text-white">
            ...
            {/* CTA Buttons - Green/Orange Theme */}
            <div className="flex flex-wrap gap-4 justify-center mb-12">
              ...
              <a 
                ...
                className="px-8 py-4 bg-orange-500 hover:bg-orange-600 text-white font-semibold rounded-lg text-lg transition-colors duration-200 shadow-md hover:shadow-lg flex items-center gap-2"
              >
